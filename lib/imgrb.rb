...
require 'imgrb/text'
require 'imgrb/exif/exif_register'
require 'imgrb/exif/exif_generic'
require 'imgrb/exif/exif_datetime'
require 'imgrb/exif/exif_fields_simple_ascii'
require 'imgrb/exif/exif_fields_thumbnail'
require 'imgrb/exif/exif_fields'
require 'imgrb/image'
